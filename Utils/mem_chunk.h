...
{
    /**
     * General list tag for chunk
     * @ingroup MemImpl
     */
    class ChunkListAllTag;
    /**
    * Free list tag chunk
    * @ingroup MemImpl
    */
    class ChunkListFreeTag;
    ...
    template< size_t size> class Chunk: 
        public ListItem< ChunkListAllTag>,
        public ListItem< ChunkListFreeTag>
    {
    ...
    public:
        ...
        typedef ListItem< ChunkListAllTag> ListAll;
        typedef ListItem< ChunkListFreeTag> ListFree;
    ...
    Chunk< size>::toStream( std::ostream& os) const
    {
        os << "Chunk " << this
           << " next " << ListAll::next()
           << ", prev " << ListAll::prev()
           << ", next_free " << ListFree::next()
           << ", prev_free " << ListFree::next() << endl;
        os << "Entries\n";
